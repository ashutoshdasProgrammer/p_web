...
import { Download, ArrowRight, Award, GraduationCap, Briefcase } from 'lucide-react';
import profileImg from '../assets/profile.png';

export default function Hero() {
  return (
    <section id="about" className="min-h-screen flex items-center justify-center pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden bg-[#080d1a]">
      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-5 flex justify-center order-1 lg:order-2">
          <div className="relative group">
            ...
            {/* Image Wrapper */}
            <div className="relative w-64 h-64 sm:w-80 sm:h-80 rounded-full overflow-hidden border-4 border-gray-800 bg-gray-900 shadow-2xl flex items-center justify-center">
              <img
                src={profileImg}
                alt="Ashutosh Das"
                className="w-full h-full absolute object-cover scale-105 group-hover:scale-110 transition-transform duration-500"
              />
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-7 space-y-6 text-center lg:text-left order-2 lg:order-1">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-white leading-tight">
            Hi, I'm <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Ashutosh Das</span>
          </h1>
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl leading-relaxed mx-auto lg:mx-0">
            Currently in my 4th year of college pursuing a B.Tech in Computer Science and Artificial Intelligence. 
            I am a passionate developer focused on building robust, high-performance web applications 
            and scalable real-time data pipelines. I love solving complex problems with modern backend tooling 
            and crafting clean, responsive, and engaging user interfaces.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
            <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800/60 backdrop-blur-sm flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Education</h4>
            ...
            <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800/60 backdrop-blur-sm flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Experience</h4>
                <p className="text-sm text-gray-300 font-medium">ML Developer Intern</p>
                <p className="text-xs text-gray-400 mt-0.5">Finesse Fleet Foundation</p>
              </div>
            </div>
            ...
            <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800/60 backdrop-blur-sm flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs text-gray-500 uppercase tracking-wider font-semibold">Focus Areas</h4>
                <p className="text-sm text-gray-300 font-medium">Real-time Pipelines</p>
                <p className="text-xs text-gray-400 mt-0.5">APIs, WebSockets & ML</p>
              </div>
            </div>
          </div>
